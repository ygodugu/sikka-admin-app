...
import { AddCountriesModal } from "./AddCountries";
import { EditCountriesModal } from "./EditCountries";
import { Alert } from "react-bootstrap";
import Spinner from "react-bootstrap/Spinner";

const fetchCountries = (pageIndex = 0, pageSize = 20, search, selectValueID, selectValueOrder, selectValueStatus) => {
  return axiosInstance
    .get(`/countries?pageIndex=${pageIndex}&pageSize=${pageSize}&search=${search}&sortBy=${selectValueID}&sortOrder=${selectValueOrder}&status=${selectValueStatus}`)
    .then((res) => res.data);
};
...
export const Countries = () => {
  ...
  const handleAddCountriesSuccess = () => {
    setShowAddModal(false);
    refetch();
  };

  const handleUpdateCountriesSuccess = () => {
    queryClient.invalidateQueries({ queryKey: ["Countries-details", CountriesId] });
  ...
  return (
    <>
        ...
        <div className="col-12">
          <div className="row heading-add">
            <aside className="ml-2 mr-2">
              <h2 className="mb-0 page-title">Countries</h2>
            </aside>
      ...
      {showAddModal ? (
        <AddCountriesModal
          handleSuccess={handleAddCountriesSuccess}
      ...
      {showEditModal ? (
        <EditCountriesModal
          id={CountriesId}
          handleSuccess={handleUpdateCountriesSuccess}
