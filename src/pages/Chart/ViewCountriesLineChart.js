...
const fetchCountries = () => {
    ...
    return axiosInstance
        .get(`/countries?pageIndex=0&pageSize=20&sortBy=createdAt`)
        .then((res) => res.data);
};
export const ViewCountriesLineChart = () => {
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Countries detalies</h2>
                        </aside>
