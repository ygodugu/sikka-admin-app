...
const fetcDocuments = () => {
    ...
    return axiosInstance
        .get(`/documents?pageIndex=0&pageSize=200&sortBy=createdAt`)
        .then((res) => res.data);
};
export const ViewDocumentsLineChart = () => {
    const { isLoading, data, refetch } = useQuery({
        queryKey: ["documents"],
        queryFn: () => fetcDocuments(),
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Documents detalies</h2>
                        </aside>
