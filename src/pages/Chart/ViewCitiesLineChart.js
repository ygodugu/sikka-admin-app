...
const fetchCities = () => {
    ...
    return axiosInstance
        .get(`/cities?pageIndex=0&pageSize=200&sortBy=createdAt`)
        .then((res) => res.data);
};
export const ViewCitiesLineChart = () => {
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Cities detalies</h2>
                        </aside>
