...
const fetchTransactions = () => {
    ...
    return axiosInstance
        .get(`/cikka-transactions?pageIndex=0&pageSize=2000&sortBy=createdAt`)
        .then((res) => res.data);
};

export const ViewTransactionsLineChart = () => {

    const { isLoading, data, refetch } = useQuery({
        queryKey: ["cikka-transactions"],
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Transactions detalies</h2>
                        </aside>
