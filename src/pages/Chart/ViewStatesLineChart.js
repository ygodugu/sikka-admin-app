...
const fetchStates = () => {
    ...
    return axiosInstance
        .get(`/states?pageIndex=0&pageSize=200&sortBy=createdAt`)
        .then((res) => res.data);
};
export const ViewStatesLineChart = () => {
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View States detalies</h2>
                        </aside>
