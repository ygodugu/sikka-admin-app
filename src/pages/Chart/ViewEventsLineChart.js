...
const fetchEvents = () => {
    ...
    return axiosInstance
        .get(`/events?pageIndex=0&pageSize=200&sortBy=createdAt`)
        .then((res) => res.data);
};
export const ViewEventsLineChart = () => {
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Events detalies</h2>
                        </aside>
