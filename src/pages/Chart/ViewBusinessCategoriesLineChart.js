...
const fetchBusinessCategories = () => {
    ...
    return axiosInstance
        .get(`/business-categories?pageIndex=0&pageSize=200&sortBy=createdAt`)
        .then((res) => res.data);
};

export const ViewBusinessCategoriesLineChart = () => {
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Business Categories createdAt'
            },
        },
        elements: {
            point: {
                ...
                <div className="col-12">
                    <div className="row heading-add">
                        ...
                        <aside className="col-sm-9">
                            <h2 className="mb-0 page-title">View Business Categories detalies</h2>
                        </aside>
